( function( ssc ) {
    ...
    CSSMatrix.prototype = {
         ...
         * Arguments can be either a vector ( e.g. [  x, y, z  ] ) or positional scalars.
         * Unspecified arguments default to one.
         */
        scale: function() {
            var scaleBy = _parseArgs( arguments, 4, 1 ),
                currentScale = this.getScale(),
                newScale = _zip( scaleBy, currentScale ).map( function( scales ) {
