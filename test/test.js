QUnit.test( 'getting the matrix for an element', function( assert ) {
    ...
    assert.deepEqual( byCSS, byElem, 'the matrices retrieved via CSS and elem should be the same');
...
QUnit.test( 'translations', function( assert ) {
    ...
    var translated = matrix.translate( 42, 69, 99 );
    var translatedVect = matrix.translate([ 42, 69, 99 ]);
    ...
    var setTranslate = matrix.setTranslate( 42 );
...
QUnit.test( 'scales', function( assert ) {
    ...
    var scaled = matrix.scale( 42, 69, 99 );
    var scaledVect = matrix.scale([ 42, 69, 99 ]);
    ...
    var setScale = matrix.setScale( 42 );
